        ...
        p-4">
          ...
          >
            ...
            <div className="flex gap-3 overflow-x-auto relative pr-[50px]">
              ...
              <div className="absolute right-0 text-pink top-0 h-full w-[60px] flex items-center justify-end pr-1" style={{background: 'linear-gradient(90deg, #ffffff00, #ffffff, #ffffff)'}}>
                <FaChevronRight/>
              </div>
            </div>
          </FormCard>
        ...
        p-4">
          ...
          >
            ...
            <div className="flex gap-4 flex-col md:flex-row md:items-end ">
              ...
              <div className="flex-1">
                <Label htmlFor="ceremony_end_time">Hora do fim do evento <span className="text-pink">(opcional)</span></Label>
                <Input
                  type="time"
            ...
            <Label htmlFor="address">Nome do Local <span className="text-pink">(opcional)</span></Label>
            <Input type="text" id="address" 
            value={state.ceremony_location} name="ceremony_location" onChange={setValue} disabled={!state.enable_ceremony} className='p-2 border rounded-md ${state.enable_ceremony ? "bg-white" : "bg-gray-100"} text-gray-400' placeholder="Clube de eventos" />
            <Label htmlFor="fulladdress">Rua, Número, Cidade, Estado <span className="text-pink">(opcional)</span></Label>
            <Input
              type="text"
            ...
            <div className="flex gap-4 flex-col md:flex-row md:items-end">
              ...
              <div className="flex-1">
                <Label htmlFor="party_end_time">Hora do fim do evento <span className="text-pink">(opcional)</span></Label>
                <Input
                  type="time"
                  id="party_end_time"
                  name="party_end_time"
